// Using the go tutorials to build a simple web app -- see https://golang.org/doc/articles/wiki/#tmp_13
...
func innoViewHandler(w http.ResponseWriter, r *http.Request) {
	title := "Innovation Project Descriptions"
	page := &Page{Title: title, Body: randomize_quote()}
	t, _ := template.ParseFiles("inno_buzz_view.html")
	t.Execute(w, page)
}

func main() {

	// serving CSS files -- https://forum.golangbridge.org/t/serving-css-files/2386/5
